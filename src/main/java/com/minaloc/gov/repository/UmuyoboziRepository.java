...
/**
 * Spring Data SQL repository for the Umuyobozi entity.
 */
@Repository
public interface UmuyoboziRepository extends JpaRepository<Umuyobozi, Long>, JpaSpecificationExecutor<Umuyobozi> {
    default Optional<Umuyobozi> findOneWithEagerRelationships(Long id) {
        return this.findOneWithToOneRelationships(id);
    }

    default List<Umuyobozi> findAllWithEagerRelationships() {
        return this.findAllWithToOneRelationships();
    }

    default Page<Umuyobozi> findAllWithEagerRelationships(Pageable pageable) {
