...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './complain.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPLAIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPLAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPLAIN actions', async () => {
      const expectedActions = [
        {
