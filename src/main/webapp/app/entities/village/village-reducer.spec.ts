...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './village.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VILLAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VILLAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VILLAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VILLAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VILLAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VILLAGE actions', async () => {
      const expectedActions = [
        {
