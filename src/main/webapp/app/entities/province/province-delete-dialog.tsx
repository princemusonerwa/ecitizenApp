...
export const ProvinceDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ecitizenApp.province.delete.question">Are you sure you want to delete this Province?</ModalBody>
      <ModalFooter>
