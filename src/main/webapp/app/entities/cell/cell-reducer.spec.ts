...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cell.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CELL_LIST actions', async () => {
    ...
    it('dispatches FETCH_CELL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CELL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CELL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CELL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CELL actions', async () => {
      const expectedActions = [
        {
