...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './office.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_OFFICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OFFICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OFFICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OFFICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OFFICE actions', async () => {
      const expectedActions = [
        {
