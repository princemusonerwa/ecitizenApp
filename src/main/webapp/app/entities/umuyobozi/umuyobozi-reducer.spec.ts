...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './umuyobozi.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UMUYOBOZI_LIST actions', async () => {
    ...
    it('dispatches FETCH_UMUYOBOZI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UMUYOBOZI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UMUYOBOZI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UMUYOBOZI actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UMUYOBOZI actions', async () => {
      const expectedActions = [
        {
