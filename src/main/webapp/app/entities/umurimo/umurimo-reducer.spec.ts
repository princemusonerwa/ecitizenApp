...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './umurimo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UMURIMO_LIST actions', async () => {
    ...
    it('dispatches FETCH_UMURIMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UMURIMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UMURIMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UMURIMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UMURIMO actions', async () => {
      const expectedActions = [
        {
