...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './umuturage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UMUTURAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_UMUTURAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UMUTURAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UMUTURAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UMUTURAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UMUTURAGE actions', async () => {
      const expectedActions = [
        {
