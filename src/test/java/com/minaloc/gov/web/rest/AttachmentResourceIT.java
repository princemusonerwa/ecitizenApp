...
class AttachmentResourceIT {
    ...
    private static final byte[] DEFAULT_ATTACHMENT_LINK = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_ATTACHMENT_LINK = TestUtil.createByteArray(1, "1");
    private static final String DEFAULT_ATTACHMENT_LINK_CONTENT_TYPE = "image/jpg";
    private static final String UPDATED_ATTACHMENT_LINK_CONTENT_TYPE = "image/png";
    ...
    public static Attachment createEntity(EntityManager em) {
        Attachment attachment = new Attachment()
            ...
            .attachmentLinkContentType(DEFAULT_ATTACHMENT_LINK_CONTENT_TYPE)
    ...
    public static Attachment createUpdatedEntity(EntityManager em) {
        Attachment attachment = new Attachment()
            ...
            .attachmentLinkContentType(UPDATED_ATTACHMENT_LINK_CONTENT_TYPE)
    ...
    void createAttachment() throws Exception {
        ...
        assertThat(testAttachment.getAttachmentLinkContentType()).isEqualTo(DEFAULT_ATTACHMENT_LINK_CONTENT_TYPE);
    ...
    void getAllAttachments() throws Exception {
        ...
        restAttachmentMockMvc
            ...
            .andExpect(jsonPath("$.[*].attachmentLinkContentType").value(hasItem(DEFAULT_ATTACHMENT_LINK_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].attachmentLink").value(hasItem(Base64Utils.encodeToString(DEFAULT_ATTACHMENT_LINK))))
    ...
    void getAttachment() throws Exception {
        ...
        restAttachmentMockMvc
            ...
            .andExpect(jsonPath("$.attachmentLinkContentType").value(DEFAULT_ATTACHMENT_LINK_CONTENT_TYPE))
            .andExpect(jsonPath("$.attachmentLink").value(Base64Utils.encodeToString(DEFAULT_ATTACHMENT_LINK)))
    ...
    void putNewAttachment() throws Exception {
        ...
        assertThat(testAttachment.getAttachmentLinkContentType()).isEqualTo(UPDATED_ATTACHMENT_LINK_CONTENT_TYPE);
    ...
    void partialUpdateAttachmentWithPatch() throws Exception {
        ...
        partialUpdatedAttachment.attachmentType(UPDATED_ATTACHMENT_TYPE);
